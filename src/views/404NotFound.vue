    ...
    <section class="bg-white px-4 dark:bg-boxdark-2 sm:px-8 overflow-hidden relative z-10">
            ...
            <div class="no-scrollbar overflow-y-auto py-20">
                <div class="mx-auto w-full max-w-[600px]">
                    <div class="text-center">
                        <a href="/" class="mx-auto mb-10 inline-flex"><img src="@/assets/images/logo/logo_transparrent.png" alt="logo" class="w-full dark:hidden" /></a>
                        <h1 class="mb-2.5 text-3xl font-black text-black dark:text-white lg:text-4xl xl:text-[50px] xl:leading-[60px]">
                            404 Not Found
                        </h1>
                        <p class="font-medium">The page you're looking is not found.</p>
                    </div>
                </div>
                
                <div class="flex justify-center mt-10">
                    <RouterLink :to="{name: 'Home'}" class="bg-primary text-white font-medium px-4 py-2 rounded-lg">
                        Back to Home
                    </RouterLink>
                </div>
                ...
                <div class="mt-10 text-center">
                    ...
                    <div class="flex items-center justify-center gap-4">
                        <a
                            ...
                            class="router-link-active router-link-exact-active flex size-10 items-center justify-center rounded-full border border-[#DFE4EA] hover:border-primary hover:bg-primary hover:text-white dark:border-strokedark dark:hover:border-primary"
                        >
                        ...
                        >
                            <svg class="fill-current" width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <defs>
                                    <clipPath id="clip0_1878_14093"><rect width="16" height="16" fill="white" transform="translate(0.5)"></rect></clipPath>
                                </defs>
                            </svg>
                        </a>
                        <a
                        ...
                        >
                            <svg class="fill-current" width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <defs>
                                    <clipPath id="clip0_1878_14091"><rect width="16" height="16" fill="white" transform="translate(0.5)"></rect></clipPath>
                                </defs>
                            </svg>
                        </a>
                        <a
        ...
        <div class="absolute left-0 top-0 -z-10 flex h-screen w-full items-center justify-around">
            <div class="flex h-full gap-20">
                <span class="block h-full w-0.5 animate-line1"><span class="block h-55 w-0.5 bg-bodydark1 dark:bg-strokedark"></span></span>
                <span class="block h-full w-0.5 animate-line2"><span class="block h-36 w-0.5 bg-bodydark1 dark:bg-strokedark"></span></span>
                <span class="ml-10 block h-full w-0.5 animate-line3"><span class="block h-40 w-0.5 bg-bodydark1 dark:bg-strokedark"></span></span>
            </div>
            <div class="flex h-full gap-20">
                <span class="mr-10 block h-full w-0.5 animate-line1"><span class="block h-55 w-0.5 bg-bodydark1 dark:bg-strokedark"></span></span>
                <span class="block h-full w-0.5 animate-line2"><span class="block h-36 w-0.5 bg-bodydark1 dark:bg-strokedark"></span></span>
                <span class="block h-full w-0.5 animate-line3"><span class="block h-40 w-0.5 bg-bodydark1 dark:bg-strokedark"></span></span>
            </div>
        </div>
    </section>
</template>
